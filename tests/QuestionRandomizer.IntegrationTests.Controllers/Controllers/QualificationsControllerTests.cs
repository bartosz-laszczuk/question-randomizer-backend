...
/// <summary>
/// Integration tests for QualificationsController
/// </summary>
public class QualificationsControllerTests : IClassFixture<CustomWebApplicationFactory>
{
    private readonly CustomWebApplicationFactory _factory;
    private readonly HttpClient _client;

    public QualificationsControllerTests(CustomWebApplicationFactory factory)
    {
        _factory = factory;
